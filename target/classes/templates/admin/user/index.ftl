                    ...
                    <div class="row row-lg">
                        <div class="col-sm-12">
                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <table id="table_list" style="word-break:break-all; word-wrap:break-all;"></table>
                                </div>
                            </div>
...
<script>
    ...
    function edit(id) {
        layer.open({
            ...
            shade: false,
            area: ['893px', '600px'],
            content: '/bookmanage/toModifyView/' + id,
            end: function (index) {
